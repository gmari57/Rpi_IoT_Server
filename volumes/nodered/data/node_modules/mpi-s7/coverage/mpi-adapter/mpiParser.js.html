...
<html lang="en">
<head>
    <title>Code coverage report for mpi-adapter/mpiParser.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">mpi-adapter</a> mpiParser.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">81.32% </span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    pa</span>rseAsync(chunk) {
<span class="cstat-no" title="statement not covered" >        debug("MPIParser parseAsync", chunk);</span>
...
<span class="cstat-no" title="statement not covered" >            this.parse(chunk, <span class="fstat-no" title="function not covered" >(e</span>rr, data) =&gt; {</span>
...
&nbsp;
        switch(obj.type) {
            case C.type.ADAPTER:
                ...
                ptr++;
&nbsp;
                <span class="missing-if-branch" title="if path not taken" >I</span>if (obj.direction !== C.adapter.direction.RESPONSE) {
<span class="cstat-no" title="statement not covered" >                    cb(new Error(`Still can't parse directions other than RESPONSE 0x20 != [0x${obj.direction.toString(16)}]`));</span>
...
&nbsp;
                break;
            case C.type.BUS:
                <span class="missing-if-branch" title="if path not taken" >I</span>if(chunk.length &lt; 6) {
<span class="cstat-no" title="statement not covered" >                    debug("MPIParser _transform err-busdata-small", chunk.length, chunk);</span>
<span class="cstat-no" title="statement not covered" >                    cb(new Error(`Incoming data too small for a bus type telegram [0x${obj.direction.toString(16)}]`));</span>
<span class="cstat-no" title="statement not covered" >                    return;</span>
                }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                        debug("MPIParser _transform err-unknown-bus-command", chunk);</span>
<span class="cstat-no" title="statement not covered" >                        cb(new Error(`Unknown bus command [0x${obj.command.toString(16)}]`));</span>
<span class="cstat-no" title="statement not covered" >                        return;</span>
                }
&nbsp;
                break;
<span class="branch-2 cbranch-no" title="branch not covered" >            default:</span>
<span class="cstat-no" title="statement not covered" >                debug("MPIParser _transform err-unknown-type", header.type);</span>
<span class="cstat-no" title="statement not covered" >                cb(new Error(`Unknown telegram type [${obj.type}]`));</span>
<span class="cstat-no" title="statement not covered" >                return;</span>
        }
&nbsp;
        cb(null, obj);
...
module.exports = MPIParser;</pre></td></tr>
</table></pre>
