...
<html lang="en">
<head>
    <title>Code coverage report for mpi-adapter/mpiSerializer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">mpi-adapter</a> mpiSerializer.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">79.23% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>103/130</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">78.22% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>79/101</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cstat-no" title="statement not covered" >        return !!Object.values(obj).find(<span class="fstat-no" title="function not covered" >e </span>=&gt; <span class="cstat-no" title="statement not covered" >e == elm)</span>;</span>
    }
    return true;
}
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >    as</span>ync serializeAsync(chunk){
...
<span class="cstat-no" title="statement not covered" >            this.serialize(chunk, <span class="fstat-no" title="function not covered" >(e</span>rr, data) =&gt; {</span>
...
&nbsp;
        let buf;
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!chunk){
<span class="cstat-no" title="statement not covered" >            cb(new Error('Input required to serialize'));</span>
        }
&nbsp;
        switch (chunk.type) {
            case C.type.ADAPTER:
                <span class="missing-if-branch" title="if path not taken" >I</span>if (chunk.direction &amp;&amp; chunk.direction !== C.adapter.direction.REQUEST) {
<span class="cstat-no" title="statement not covered" >                    cb(new Error(`Unsupported adapter command direction [${chunk.direction}] != (0x02) REQUEST`));</span>
                }
&nbsp;
...
&nbsp;
                        ...
                        <span class="missing-if-branch" title="if path not taken" >I</span>if (isValid(chunk.mpiBusSpeed)) {
                            let speed = <span class="cstat-no" title="statement not covered" >parseInt(chunk.mpiBusSpeed);</span>
<span class="cstat-no" title="statement not covered" >                            if(isNaN(speed) || !isValid(speed, C.speed)){</span>
<span class="cstat-no" title="statement not covered" >                                cb(new Error(`Unsupported speed value [${chunk.mpiBusSpeed}] for adapter connect command`));</span>
                            }
                            //buf.writeUInt8(chunk.mpiBusSpeed, 15); //defaults to 0x02 (187K)
                        }
&nbsp;
                        <span class="missing-if-branch" title="else path not taken" >E</span>if (isValid(chunk.mpiLocalAddress)) {
                            let localAddr = parseInt(chunk.mpiLocalAddress);
                            <span class="missing-if-branch" title="if path not taken" >I</span>if (isNaN(localAddr) || localAddr &lt; 0 || localAddr &gt; 127) {
<span class="cstat-no" title="statement not covered" >                                cb(new Error(`Invalid MPI local address value [${chunk.mpiLocalAddress}] for adapter connect command`));</span>
                            }
...
<span class="cstat-no" title="statement not covered" >                        cb(new Error(`Unsupported adapter command [${chunk.command}]`));</span>
...
&nbsp;
                switch (chunk.command) {
                    case C.bus.command.CONNECTION_REQUEST:
                        ...
                        let slot = 2;
                        <span class="missing-if-branch" title="if path not taken" >I</span>if (isValid(chunk.slot)) {
<span class="cstat-no" title="statement not covered" >                            slot = parseInt(chunk.slot);</span>
                        }
&nbsp;
                        let commType = 1; //(1=PG 2=OP 3=S7Basic)
                        <span class="missing-if-branch" title="if path not taken" >I</span>if (isValid(chunk.commType, C.bus.connection.commType)) {
<span class="cstat-no" title="statement not covered" >                            commType = parseInt(chunk.commType);</span>
                        }
&nbsp;
                        buf = new Buffer(18);
...
&nbsp;
                        buf = Buffer.alloc(8);
                        buf.writeUInt8(ccStatus ? 0x01 : <span class="branch-1 cbranch-no" title="branch not covered" >0xff,</span> 7); // 0x01 == OK, not sure about 0xff
                        break;
                    
                    case C.bus.command.DATA_EXCHANGE:
                        <span class="missing-if-branch" title="if path not taken" >I</span>if (!(chunk.payload instanceof Buffer)) {
<span class="cstat-no" title="statement not covered" >                            cb(new Error(`Payload required for a data exchange telegram`));</span>
<span class="cstat-no" title="statement not covered" >                            return;</span>
                        }
&nbsp;
                        let dataSeq = parseInt(chunk.sequence) || 0;
                        <span class="missing-if-branch" title="if path not taken" >I</span>if (isNaN(dataSeq) || dataSeq &lt; 0 || dataSeq &gt; 0xff) {
<span class="cstat-no" title="statement not covered" >                            cb(new Error(`Invalid telegram sequence [${chunk.sequence}]`));</span>
<span class="cstat-no" title="statement not covered" >                            return;</span>
                        }
&nbsp;
                    ...
                    case C.bus.command.DATA_ACK:
                        ...
                        <span class="missing-if-branch" title="if path not taken" >I</span>if (isNaN(ackSeq) || ackSeq &lt; 0 || ackSeq &gt; 0xff) {
<span class="cstat-no" title="statement not covered" >                            cb(new Error(`Invalid telegram sequence [${chunk.sequence}]`));</span>
<span class="cstat-no" title="statement not covered" >                            return;</span>
                        }
&nbsp;
...
&nbsp;
                        buf = Buffer.alloc(9);
                        buf.writeUInt8(ackStatus ? 0x01 : <span class="branch-1 cbranch-no" title="branch not covered" >0xff,</span> 7);
...
&nbsp;
<span class="branch-6 cbranch-no" title="branch not covered" >                    default:</span>
<span class="cstat-no" title="statement not covered" >                        cb(new Error(`Unsupported command [${chunk.command}] for bus data`));</span>
<span class="cstat-no" title="statement not covered" >                        return;</span>
                }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                cb(new Error(`Unsupported telegram type [${chunk.type}]`));</span>
<span class="cstat-no" title="statement not covered" >                return;</span>
        }
&nbsp;
        //write type
...
module.exports = MPISerializer;</pre></td></tr>
</table></pre>
<div class='push'></div><!-- for sticky footer -->
</div><!-- /wrapper -->
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Fri Aug 02 2019 11:54:48 GMT-0300 (-03)
</div>
</div>
